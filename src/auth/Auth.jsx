      ...
      <main className="auth__wrap">
        <section className="auth__visual">
          ...
          <div className="auth__overlay">
            ...
            <h2 className="auth__heading">A calmer home starts with pieces you love.</h2>
              ...
              <>
                ...
                <form className="auth__form" onSubmit={(e) => e.preventDefault()}>
                  <div className="auth__field">
                    ...
                    <input className="auth__input" id="email" type="email" placeholder="you@example.com" required />
                  </div>

                  <div className="auth__field">
                    <label htmlFor="password">Password</label>
                    <input className="auth__input" id="password" type="password" placeholder="Enter your password" required />
                  </div>
              ...
              <>
                ...
                <form className="auth__form" onSubmit={(e) => e.preventDefault()}>
                  <div className="auth__field">
                    ...
                    <input className="auth__input" id="name" type="text" placeholder="Alex Rivera" required />
                  </div>

                  <div className="auth__field">
                    <label htmlFor="email-up">Email</label>
                    <input className="auth__input" id="email-up" type="email" placeholder="you@example.com" required />
                  </div>

                  <div className="auth__field">
                    <label htmlFor="password-up">Password</label>
                    <input className="auth__input" id="password-up" type="password" placeholder="At least 6 characters" required />
                  </div>
